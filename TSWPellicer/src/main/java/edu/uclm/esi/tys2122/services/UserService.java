...
public class UserService {
	...
	public void save(User user) {
		User userSave = userRepo.findByEmail(user.getEmail()); 
		...
		if (userSave == null) {
			...
			throw new ResponseStatusException(HttpStatus.FORBIDDEN, "Ese email ya se encuentra registrado en el sistema");
