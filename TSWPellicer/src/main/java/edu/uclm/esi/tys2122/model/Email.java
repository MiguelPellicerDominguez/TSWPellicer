...
public class Email {
	...
	public void send(String destinatario, String subject, String body) {
		...
		String port="587";
		String sender="pellilaboratorio@gmail.com";	// REMITENTE
		String serverUser="pellilaboratorio@gmail.com";	// USUARIO
		String userAutentication= "true";
		String pwd="pellilaboratorioTSW";				// PONER LA CONTRASEÑA
